...
Using the \href{https://github.com/pieqq/PyGeoIpMap}{PyGeoIpMap} library, we were also able to graph the approximate locations of attacker IP addresses (Figure 1).
